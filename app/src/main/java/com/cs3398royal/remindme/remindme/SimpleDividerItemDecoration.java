 ...
 *
 * This class is an ItemDecoration that draws various dividing lines between items in a
 * RecyclerView.
 *
        ...
        if (mOrientation == -1) {
            if (parent.getLayoutManager() instanceof LinearLayoutManager) {
                ...
                throw new IllegalStateException(
                        "SimpleDividerItemDecoration can only be used with a LinearLayoutManager.");
            }
        }
        return mOrientation;
    }
